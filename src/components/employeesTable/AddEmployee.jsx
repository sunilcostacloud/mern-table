...
import { addEmployee, addEmployeeReset } from 'store/addEmployee';
...
const AddEmployee = (props) => {
    ...
    const { employeeAddedData, employeeAddDataLoading, employeeAddedDataIsError, employeeAddedDataError, employeeAddedDataIsSuccess } = useSelector((state) => state.addEmployeeData);
    ...
    useEffect(() => {
        ...
        if (employeeAddedDataIsSuccess) {
            ...
            setCurrentPage(1)
            dispatch(getEmployeeTable({ search: "", gender: "all", status: "all", sort: "new", page: 1 }));
